...
if display
{
	...
	draw_sprite_ext(spr_combonumbers,string_char_at(string(combo_amount),1),775 + shake3x,(720 - comboletter_rise[5] + (sin((_time - 90) / 10) * 5)) + shake3y,1,1,0,c_white,1)
	if combo_amount > 9
		draw_sprite_ext(spr_combonumbers,string_char_at(string(combo_amount),2),825 + shake3x,(720 - comboletter_rise[5] + (sin((_time - 90) / 10) * 5)) + shake3y,1,1,0,c_white,1)
}
