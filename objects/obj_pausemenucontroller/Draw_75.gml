if obj_player.pause
{
	...
	if display_logo
		draw_sprite_with_wave(640,25 - scroll_disp,spr_title,1,1,0,3,_time,30,image_blend)

	if disp_state = 0
	{
		draw_sprite_with_wave(640,350 - scroll_disp,spr_resumeicon,0,1,0,3,_time,30,image_blend)
