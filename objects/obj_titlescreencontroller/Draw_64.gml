...
if disp_state = 1
{
	...
	draw_sprite_ext(spr_volslider_hand,0,420 + (800 * sfxvol),150,1,1,0,c_white,1)
	draw_sprite_ext(spr_volslider_hand,0,420 + (800 * muvol),275,1,1,0,c_white,1)
	draw_sprite_with_wave(300,150,spr_sfxvolicon,0,1,0,3,_time,30,image_blend)
	draw_sprite_with_wave(300,275,spr_muvolicon,0,1,0,3,_time,30,image_blend)
