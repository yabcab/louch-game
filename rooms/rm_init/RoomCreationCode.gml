...
globalvar score_font; score_font = font_add_sprite_ext(spr_scorenumbers,"01 23456789:AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz.!?/%[]",0,0)
...
room_set_live(rm_testroom_secret1,1)
room_set_live(rm_testroom_secret2,1)
room_set_live(rm_testroom_secret3,1)